...
int main(int argc, char** argv) {
    ...
    //
    // kniznica_t k2 = zoSuboru("C:\\Users\\Peťo Chomič\\Desktop\\materialy skola\\kniznica.txt"); //ked mam nepozicanu knihu s jednym autorom nezapise nulu ale divny znak, 
    //ale ked vypisem subor tak sa vypise dobre, je tam nula
    ...
    printf("%s\n", "teraz pridavajte knihy. pre ukazanie niektorych funkcionalit je potrebne aby ste zadali aspon 2 knihy, prvvu pozicanu a druhu nie. ak ste zadali knihy napiste STOP");
    ...
    vratenie(kniznica.knihy[1].nazov, citatel, &kniznica);
    printf("%s\n", "zobrazi ci je kniha pozicana. ma byt 0");
    printf("%d\n", kniznica.knihy[1].pozicana);
    int najdlhsia = najdlhsiaVypozicka(&kniznica);
    printf("%s\n", "najdlhsia vypozicka");
