...
//    kniha_t kniha3 = zoStringuPreSubor(k3); //musim dat aj na zaciatok \t, inac nedostanem nazov zo split. Bze ohladu na to ci ho tam dam split vrati
//    //ako prvu hodnotu P� ale s nim je druhy uz nazov, inac je druhy prvy z autorov. split2 tiez vracia rovnaku prvu hodnotu ale ani po pridani zaciatocneho \t nevrati nazov 
//    printf("%s\n", kniha3.nazov);
//    printf("%s\n", kniha3.autori[0]);
//    printf("%d\n", kniha3.pozicana);
//    printf("%s\n", kniha3.citatel);
//    printf("%d\n", kniha3.doba);
//    kniha_t kniha4 = zoStringu("\tsailor on the seas of the fate\tmichael moorcock,peter chomic\t1\tpeter\t20"); //detto
//    printf("%s\n", kniha4.nazov);
//    printf("%s\n", kniha4.autori[0]);
//    printf("%s\n", kniha4.autori[1]);
//    printf("%d\n", kniha4.pozicana);
...
//    kniznica_t k2 = zoSuboru("c:\\kniznica.txt"); //musel som robit pre subor dalsiu metodu zoStringuPreSubor lebo 
//    //pri subore sa uz metoda zoStringu sprava normalne (nemusim dat zaciatocne \t)
//    //nazov prvej knihy sa ulozi ako @� aj ked je po splitnuti spravny string. citatel je niekedy tiez @� a inokedy normalny aj ked vstup je rovnaky
//    char* s_k2 = kniznica_toString(&kniznica); //kvoli horeuvedenym problemom tu nejde ani kniznica_toString
//    printf("%s\n", s_k2);
//
