...
int main(int argc, char** argv) {
    printf("%s\n", "******************");
        ...
        printf("%d\n", poc_nep2);
        pozicka(kniznica.knihy[1].nazov, kniznica.knihy[0].citatel, &kniznica);
...
//    printf("%s\n", "koniec");
    ...
    //v metode pocetTitulovSRoznymNazvom ked som uvolnoval lokalnu kniznicu tak mi to sposobilo segmentation fault
}
